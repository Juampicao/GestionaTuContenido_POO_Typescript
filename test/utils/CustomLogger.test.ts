...
//         let response = new CustomLogger().logDebug("Esto es un CustomLogger Debug")
        
//         expect(response).toBe("Esto es un CustomLogger Debug");
//     });

//     // test('Caso 1.3 - Crear LogError.', () => {

//     //     let response = new CustomLogger().logError("Esto es un CustomLogger error")
